  ...
  data: {
    posts: [
      ...
      },
      {
        ...
        message:
          'I just made this soup today and it’s so tasty! didn’t have corn at home but still turned out very good. It’s a winner!',
      },
      {
        profilepic: '/images/profile.png',
        name: 'CATHERINE LEONARDO',
        foodielevel: 'Mentor',
        bio: 'Never was adventurous until my boyfriend introduced me to Japanese food!',
        date: 'February 13, 2021 @ 12:58 pm',
        message:
          'I LOVE this White Chicken Chili! Refreshingly different taste than any chicken chili I’ve made before. Freezes well too!',
      },
      {
        profilepic: '/images/profile.png',
        name: 'KALI',
        foodielevel: 'Novice',
        bio: "Food is my passion. So is cooking. Invite me for dinner and I'll be there!",
        date: 'February 13, 2021 @ 11:31 am',
        message:
          'This recipe is dynamite! My partner usually won’t eat beans but he finished the whole pot!',
      },
    ],
    selectedPost: null,
  },
